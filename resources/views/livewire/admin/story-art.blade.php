            ...
            <div class="bg-white dark:bg-[#0f172a] rounded-2xl border border-gray-200 dark:border-white/5 overflow-hidden">
                ...
                <div class="p-3">
                    ...
                    <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 mb-3">
                        <span class="flex items-center gap-1"><i class="fa-solid fa-eye text-[10px]"></i> {{ number_format($story->views) }}</span>
                        <span class="flex items-center gap-1"><i class="fa-solid fa-chart-simple text-[10px]"></i> {{ number_format($story->impressions) }}</span>
                        @if($story->replies > 0)
                            <span class="flex items-center gap-1"><i class="fa-solid fa-reply text-[10px]"></i> {{ $story->replies }}</span>
                        @endif
                    </div>
                    @if($story->product)
