...
<div x-data="{ abierto: false }" class="w-full grid grid-cols-2 gap-2 md:gap-3">
    ...
    <div @click="abierto = !abierto" class="flex items-center gap-3 px-3 py-2.5 md:px-4 md:py-3 bg-[#F1F5FA] dark:bg-gray-800 rounded-xl min-w-0 cursor-pointer select-none">
        <span class="block flex-shrink-0 text-[#14325E] dark:text-gray-200">
        ...
        <i class="fa-solid fa-chevron-down text-[10px] text-gray-400 transition-transform" :class="{ 'rotate-180': abierto }"></i>
    </div>
    <div class="flex items-center gap-3 px-3 py-2.5 md:px-4 md:py-3 bg-[#F1F5FA] dark:bg-gray-800 rounded-xl min-w-0">
        <span class="block flex-shrink-0 text-[#14325E] dark:text-gray-200">
    ...
    <div x-show="abierto" x-transition class="col-span-2 bg-[#0EB45D]/10 border border-[#0EB45D]/20 rounded-xl p-3" style="display: none;">
