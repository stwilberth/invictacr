...
<nav class="bg-[#14325E] shadow-lg w-full z-[60] print:hidden border-b border-white/10"
     x-data="navbarState()"
     x-init="init()">
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-14 md:h-[100px] items-center">
            ...
            <div class="hidden md:flex items-center space-x-1 lg:space-x-4">
                ...
                <a href="/relojes"
                   class="{{ str_starts_with($currentPath, 'relojes') ? 'text-[#00C4FF] bg-white/5' : 'text-white' }} hover:text-[#00C4FF] px-3 py-2 rounded-md text-sm lg:text-base font-black uppercase tracking-tighter transition-all duration-200">
                    Relojes
                </a>

                <a href="/garantia"
                   class="{{ $currentPath === 'garantia' ? 'text-[#00C4FF] bg-white/5' : 'text-white' }} hover:text-[#00C4FF] px-3 py-2 rounded-md text-sm lg:text-base font-black uppercase tracking-tighter transition-all duration-200 flex items-center gap-1.5">
                    <i class="fa-solid fa-shield-check text-xs {{ $currentPath === 'garantia' ? 'text-[#00C4FF]' : 'text-[#00C4FF]/70' }}"></i>
                    Garantía
                </a>

                <a href="/resenas"
                   class="{{ $currentPath === 'resenas' ? 'text-[#00C4FF] bg-white/5' : 'text-white' }} hover:text-[#00C4FF] px-3 py-2 rounded-md text-sm lg:text-base font-black uppercase tracking-tighter transition-all duration-200 flex items-center gap-1.5">
                ...
                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                    ...
                    <div x-show="open"
                         ...
                         style="display: none;">
                        <a href="/como-comprar" class="block px-4 py-2 text-sm text-white hover:text-white hover:bg-white/5 transition-colors">Cómo Comprar</a>
                        <a href="/sobre-nosotros" class="block px-4 py-2 text-sm text-white hover:text-white hover:bg-white/5 transition-colors">Sobre Nosotros</a>
                        <a href="/resistencia-agua" class="block px-4 py-2 text-sm text-white hover:text-white hover:bg-white/5 transition-colors">Resistencia al Agua</a>
                        <a href="https://correos.go.cr/rastreo/" target="_blank" class="block px-4 py-2 text-sm text-white hover:text-white hover:bg-white/5 transition-colors">Rastrear Envío</a>
                    </div>
                </div>
    ...
    <div x-show="mobileMenuOpen"
         ...
         class="md:hidden fixed inset-0 bg-[#14325E] z-40 overflow-y-auto"
         style="display: none;">
        <div class="min-h-screen flex flex-col pt-4 pb-6">
            <div class="flex items-center justify-between px-4 py-3 border-b border-white/10">
                <span class="text-xs font-bold text-white uppercase tracking-widest">Menú</span>
                <button @click="mobileMenuOpen = false"
                        class="text-white hover:text-white p-2 -mr-2 rounded-lg hover:bg-white/10 transition-colors"
            ...
            @auth
                <div class="py-4 border-b border-white/5">
                    <div class="px-4 mb-3">
                        <p class="text-xs font-bold text-white uppercase tracking-widest mb-1">Sesión activa</p>
