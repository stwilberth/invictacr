        ...
        <div class="max-w-7xl mx-auto px-4 pt-6 md:pt-12">
            ...
            <div class="flex flex-col md:flex-row gap-8 pb-12" x-data="{ filterOpen: false, searchOpen: false }">
                ...
                <div class="flex-1 min-w-0 relative">
                    ...
                    <div
                        id="products-grid"
                        class="grid grid-cols-2 md:grid-cols-5 gap-2 md:gap-4"
                    ...
                    <div id="catalog-empty-state" class="text-center py-6 px-4">
                        <div class="max-w-2xl mx-auto">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                                ...
                                <a href="https://wa.me/50686711422?text={{ urlencode('Hola, busco un reloj Invicta: ' . $refUrl) }}"
                                   target="_blank"
    ...
    <script>
        ...
        (function() {
            ...
            function ensureGridExists() {
                ...
                gridDiv.className = 'grid grid-cols-2 md:grid-cols-5 gap-2 md:gap-4';
