<x-app-layout title="Relojes Invicta Originales en Costa Rica" description="Comprá relojes Invicta 100% originales en Costa Rica. Cientos de modelos, envío gratis en GAM, pago contra entrega y garantía real de 6 meses." hide-nav>
    @php
        ...
        $refUrl = url('/') . ($refCode ? '?ref=' . $refCode : '');
    @endphp
    <!-- Search Bar Hero -->
            ...
            <div id="badgesScroll" class="md:overflow-visible md:flex md:justify-center">
                <div class="badges-track md:flex md:flex-wrap md:justify-center md:gap-x-6 md:gap-y-1">
                    ...
                    <div class="flex items-center gap-1.5 sm:gap-2 font-bold text-[10px] sm:text-xs uppercase tracking-wider whitespace-nowrap">
                        ...
                        <span class="text-emerald-600 dark:text-emerald-400">Envío Gratis</span>
                    </div>
                    <div class="flex items-center gap-1.5 sm:gap-2 text-gray-700 dark:text-gray-300 font-bold text-[10px] sm:text-xs uppercase tracking-wider whitespace-nowrap">
                        <i class="fa-solid fa-hand-holding-dollar text-[#00C4FF] text-sm"></i>
                        <span>Pago contra entrega en el GAM</span>
                    </div>
                    <div class="flex items-center gap-1.5 sm:gap-2 text-gray-700 dark:text-gray-300 font-bold text-[10px] sm:text-xs uppercase tracking-wider whitespace-nowrap">
    ...
    <section class="py-5 bg-green-600 dark:bg-green-700">
        <div class="max-w-4xl mx-auto px-4 text-center text-white">
            ...
            <a href="https://wa.me/50686711422?text={{ urlencode('Hola, me interesan las ofertas y novedades de relojes Invicta: ' . $refUrl) }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 bg-white text-green-700 font-bold px-6 py-3 rounded-lg hover:bg-gray-100 transition-all duration-300">
